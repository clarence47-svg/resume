...
def compose_resume(
    ...
    return ResumeDocument(
        ...
        professional_overview=result.professional_introduction.overview.content,
        skills=result.professional_introduction.keywords or result.keyword_coverage.matched,
        ...
        section_statuses={
            ...
            "professional_introduction": result.professional_introduction.status,
...
def _application_materials(
    ...
    summary = result.personal_introduction.overview.content
    professional = result.professional_introduction.overview.content
    ...
    cover_letter = (
        ...
        f"{professional}{evidence_sentence}\n\n"
